...
class TestContract(BoaTest):
    ...
    def test_Method1(self):
        output = Compiler.instance().load('%s/boa_test/example/MethodTest.py' % TestContract.dirname, use_nep8=False).default
        out = output.write()
    ...
    def test_Method2(self):
        output = Compiler.instance().load('%s/boa_test/example/MethodTest2.py' % TestContract.dirname, use_nep8=False).default
        out = output.write()
    ...
    def test_MethodTest3(self):
        output = Compiler.instance().load('%s/boa_test/example/MethodTest3.py' % TestContract.dirname, use_nep8=False).default
        out = output.write()
        tx, results, total_ops, engine = TestBuild(out, [], self.GetWallet1(), '', '02')
        self.assertEqual(len(results), 1)
    ...
    def test_MethodTest4(self):
        output = Compiler.instance().load('%s/boa_test/example/MethodTest4.py' % TestContract.dirname, use_nep8=False).default
        out = output.write()
        tx, results, total_ops, engine = TestBuild(out, [], self.GetWallet1(), '', '02')
        self.assertEqual(len(results), 1)
    ...
    def test_MethodTest5(self):
        output = Compiler.instance().load('%s/boa_test/example/MethodTest5.py' % TestContract.dirname, use_nep8=False).default
        out = output.write()
        tx, results, total_ops, engine = TestBuild(out, [], self.GetWallet1(), '', '02')
        self.assertEqual(len(results), 1)
    ...
    def test_MethodTest6(self):
        output = Compiler.instance().load('%s/boa_test/example/Fibonacci.py' % TestContract.dirname, use_nep8=False).default
        out = output.write()
