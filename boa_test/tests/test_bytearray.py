...
class TestContract(BoaTest):
    ...
    def test_BA1(self):
        output = Compiler.instance().load('boa_test/example/ByteArrayTest.py').default
        out = output.write()
    ...
    def test_BA2(self):
        output = Compiler.instance().load('boa_test/example/ByteArrayTest2.py').default
        out = output.write()
    ...
    def test_BA3(self):
        output = Compiler.instance().load('boa_test/example/ByteArrayTest3.py').default
        out = output.write()
